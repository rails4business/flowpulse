Rubrica 1 PosturaCorretta
Qui raccontiamo, passo dopo passo, lo sviluppo del progetto.
Partiamo dai problemi reali di chi si rivolge a noi e costruiamo piccoli progetti come soluzioni,
spiegando le scelte che facciamo lungo il percorso.

In questa puntata (in breve)
Il problema: quando allenamento e alimentazione non bastano più
Il bivio: medico vs benessere (e perché spesso non funziona)
La soluzione: un percorso della salute con una mappa chiara
Cosa abbiamo fatto: 60 Movimenti alla Scrivania
Prossimo passo: una porta d’ingresso semplice su PosturaCorretta
Quando il corpo non risponde più come prima
...
- il fisico non lo sopporta più

- oppure non hai tempo (lavoro, famiglia, ritmi)
...
Quando inizi a capire come funziona il corpo
e impari a leggere i segnali, diventa più facile orientarti:

- capire cosa scegliere

- capire quando allenarti e quando recuperare

- trovare i professionisti adatti
...
- metodiche e professioni che possono aiutarti

- abitudini, comportamento e stile di vita

- progetti e strumenti per vivere in un mondo che corre troppo

Cosa abbiamo fatto a dicembre
...
Perché siamo ripartiti da qui
Sul canale YouTube c’è già molto materiale:

postura, esercizi, autotrattamenti, metodiche, professionisti.
...
Il problema più grande (che non si vede)
...
- quali professionisti lo possono aiutare
...
Come ogni viaggio ha bisogno di un diario,
questo vale per la salute, la formazione e i progetti di lavoro.
