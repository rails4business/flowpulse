...
class ServicesController < ApplicationController
  ...
  private
    ...
    def service_params
      params.expect(service: [ :name, :description, :n_eventdates_planned, :price_enrollment_euro, :price_ticket_dash, :min_tickets, :max_tickets, :open_by_journey, :taxbranch_id, :lead_id, :meta ])
    end
end
end
