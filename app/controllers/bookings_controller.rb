class BookingsController < ApplicationController
  ...
  private
    ...
    def booking_params
      params.expect(booking: [ :service_id, :eventdate_id, :contact_id, :enrollment_id, :commitment_id, :status, :mode, :participant_role, :requested_by_lead_id, :invited_by_lead_id, :price_euro, :price_dash, :notes, :meta ])
    end
end
