class ContactsController < ApplicationController
  ...
  private
    ...
    def contact_params
      params.expect(contact: [ :first_name, :last_name, :lead_id, :email, :phone, :date_of_birth, :place_of_birth, :fiscal_code, :vat_number, :billing_name, :billing_address, :billing_zip, :billing_city, :billing_country, :meta ])
    end
end
